...
register_provider('openai', OpenAICompatibleProvider,
    display_name='OpenAI',
    models=['gpt-4o', 'gpt-4o-mini', 'gpt-4-turbo', 'gpt-3.5-turbo', 'o1', 'o1-mini', 'o3-mini', 'gpt-4.1', 'gpt-4.1-mini'])
...
register_provider('mistral', OpenAICompatibleProvider,
    ...
    models=['mistral-large-latest', 'mistral-small-latest', 'mistral-medium-latest', 'open-mistral-nemo', 'codestral-latest', 'mistral-embed'],
...
register_provider('groq', OpenAICompatibleProvider,
    display_name='Groq',
    models=['llama-3.3-70b-versatile', 'llama3-70b-8192', 'llama3-8b-8192', 'mixtral-8x7b-32768', 'gemma2-9b-it', 'deepseek-r1-distill-llama-70b'],
...
register_provider('anthropic', AnthropicProvider,
    ...
    models=['claude-sonnet-4-20250514', 'claude-3-5-sonnet-20241022', 'claude-3-5-haiku-20241022', 'claude-3-opus-20240229', 'claude-3-sonnet-20240229'])

from .google_provider import GoogleProvider
register_provider('google', GoogleProvider,
    display_name='Google Gemini',
    models=['gemini-2.5-pro-exp-03-25', 'gemini-2.0-flash', 'gemini-2.0-flash-lite', 'gemini-1.5-pro', 'gemini-1.5-flash', 'gemini-1.5-flash-8b', 'gemini-2.0-flash-exp'])

from .ollama_provider import OllamaProvider
register_provider('ollama', OllamaProvider,
    display_name='Ollama (Local)',
    models=['llama3.3', 'llama3.1', 'llama3', 'mistral', 'qwen2.5', 'deepseek-r1', 'codellama', 'gemma2', 'mixtral', 'phi4', 'nomic-embed-text'])
