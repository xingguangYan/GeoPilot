...
def detect_qgis():
                        ...
                        qgis_versions.append(
                            {
                                ...
                                "bin": (
                                    ...
                                    if os.path.isdir(os.path.join(qgis_path, "bin"))
                                    else None
                                ),
                                "apps": (
                                    os.path.join(qgis_path, "apps", "qgis")
                                    if os.path.isdir(os.path.join(qgis_path, "apps", "qgis"))
                                    else None
                                ),
                            }
                        )
    ...
    if os.path.exists(r"D:\QGIS\bin\qgis-bin.exe") and os.path.exists(r"D:\QGIS\apps\qgis"):
        qgis_versions.append(
            {"path": r"D:\QGIS", "version": "OSGeo4W", "bin": r"D:\QGIS\bin", "apps": r"D:\QGIS\apps\qgis"}
        )
